...
internal open class TalkativeButton : Focusable {
    //open class Chapter4.TalkativeButton : Chapter4.Focusable {
...
internal fun TalkativeButton.giveSpeech() {
    // fun Chapter4.TalkativeButton.Chapter4.giveSpeech() {
}
...
fun eval2(e: Expr2): Int =
    when (e) {
        ...
        is Expr2.Sum -> eval2(e.right) + eval2(
            e.left
        )
    }
